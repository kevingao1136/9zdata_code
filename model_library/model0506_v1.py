...
def load_data(item_path, train_start, val_end, test_start, test_end):
    ...
    Returns:
        ...
        test_df: test data
    """
    df = pd.read_csv(item_path, header=None, compression='gzip')
...
def export_results(item_code, train, val1, val2, test, export_result_meta_data, export_img):
    ...
    if export_result_meta_data:
        ...
        meta_data['test_start_time'] = ['2021-05-13','2021-06-03','2021-07-01','2021-07-29']
        meta_data['test_end_time'] = ['2021-06-02','2021-06-30','2021-07-28','2021-08-25']
...
data_path = f"/app2/kevin_workspace/data0506_encrypt/"
output_path = f"/app/python-scripts/kevin_workspace/outputs/output0506_v1/"
...
test_start, test_end = '2021-05-13', '2021-08-25'
...
#* DEFINE ITEM LIST
item_list = [i[:i.index(".csv.gz")] for i in os.listdir('/app2/kevin_workspace/data0506_encrypt/')]
...
if __name__ == '__main__':
    ...
    unit_price = pd.read_csv('/app/python-scripts/kevin_workspace/assist_data/unit_price0506.csv.gz',parse_dates=['day_dt'],compression='gzip')
