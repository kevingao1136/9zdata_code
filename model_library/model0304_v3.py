...
if __name__ == '__main__':
    ...
    img_path = f"/app/python-scripts/kevin_workspace/outputs/output0304_submit_retrain_v2/train_img/"
    log_path = f"/app/python-scripts/kevin_workspace/outputs/output0304_submit_retrain_v2/log/"
    result_data_path = f"/app/python-scripts/kevin_workspace/outputs/output0304_submit_retrain_v2/result_data/"
    meta_path = f"/app/python-scripts/kevin_workspace/outputs/output0304_submit_retrain_v2/meta_data/"
    export_result_data = True
    ...
    # item_list = [i[:-4] for i in os.listdir('/app/python-scripts/kevin_workspace/outputs/output0304_submit/train_img/') if i.endswith('.png')]
