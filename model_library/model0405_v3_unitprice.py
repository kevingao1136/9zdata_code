...
if __name__ == '__main__':
    ...
    img_path = f"/app/python-scripts/kevin_workspace/outputs/output0405_v3_unit_price/train_img/"
    log_path = f"/app/python-scripts/kevin_workspace/outputs/output0405_v3_unit_price/log/"
    result_data_path = f"/app/python-scripts/kevin_workspace/outputs/output0405_v3_unit_price/result_data/"
    meta_data_path = f"/app/python-scripts/kevin_workspace/outputs/output0405_v3_unit_price/meta_data/"
