...
def export_results(item_code, train, val1, val2, test, export_result_meta_data, export_img):
    ...
    if export_result_meta_data:
        ...
        meta_cols = ['model_id','scenario','aid','model_time','log_path','result_path',
                    ...
                    'v2_start_time','v2_end_time','v2_accuracy','v2_sell_thru','package','test_store_cnt','item_code']
        meta_data = meta_data[meta_cols]
        meta_data = pd.concat([meta_data]*4, ignore_index=True)
        meta_data['test_start_time'] = ['2021-04-15','2021-05-13','2021-06-03','2021-07-01']
        meta_data['test_end_time'] = ['2021-05-12','2021-06-02','2021-06-30','2021-07-28']
...
def main(item, threshold):
    ...
    with open(f"{log_path}{item}.log", "w") as train_log, contextlib.redirect_stdout(train_log), contextlib.redirect_stderr(train_log):
        try:
            ...
            #     print(f"NO 2019 TRAINING DATA, SKIP ITEM")
            #     return None
            ...
            train_val_df.num_items_in_offer.fillna(10,inplace=True)
            ...
            test_df.num_items_in_offer.fillna(10,inplace=True)
            ...
            X_features = ['year','month','day_of_prom','isweekend','day_type','is_5th','store_type','activity_desc',
                        'prom0','prom1','prom2','prom3','prom4','prom5','prom6','prom7', 'is_vip','free_gift',
                        'required_num','unit_price','p_rate','dis_spring','num_items_in_offer']
...
if __name__ == '__main__':
    ...
    data_path = f"/app2/kevin_workspace/data0405/"
    img_path = f"/app/python-scripts/kevin_workspace/outputs/output0405_v1/train_img/"
    log_path = f"/app/python-scripts/kevin_workspace/outputs/output0405_v1/log/"
    result_data_path = f"/app/python-scripts/kevin_workspace/outputs/output0405_v1/result_data/"
    meta_data_path = f"/app/python-scripts/kevin_workspace/outputs/output0405_v1/meta_data/"
    ...
    #* DEFINE DATES
    train_val_start, train_val_end = '2019-01-01', '2021-02-24'
    test_start, test_end = '2021-04-15', '2021-07-28'
    v1_start, v1_end = '2021-01-07', '2021-01-27'
    v2_start, v2_end = '2021-01-28', '2021-02-24'
    ...
    unit_price = pd.read_csv('/app/python-scripts/kevin_workspace/assist_data/unit_price0405.csv.gz',parse_dates=['day_dt'],compression='gzip')
