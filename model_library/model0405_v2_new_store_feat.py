...
if __name__ == '__main__':
    ...
    img_path = f"/app/python-scripts/kevin_workspace/outputs/output0405_v2_new_store_feat/train_img/"
    log_path = f"/app/python-scripts/kevin_workspace/outputs/output0405_v2_new_store_feat/log/"
    result_data_path = f"/app/python-scripts/kevin_workspace/outputs/output0405_v2_new_store_feat/result_data/"
    meta_data_path = f"/app/python-scripts/kevin_workspace/outputs/output0405_v2_new_store_feat/meta_data/"
