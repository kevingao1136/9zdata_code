...
img_path = f"/app/python-scripts/kevin_workspace/outputs/output0102_v3_sample_weight/train_img/"
log_path = f"/app/python-scripts/kevin_workspace/outputs/output0102_v3_sample_weight/log/"
result_data_path = f"/app/python-scripts/kevin_workspace/outputs/output0102_v3_sample_weight/result_data/"
meta_data_path = f"/app/python-scripts/kevin_workspace/outputs/output0102_v3_sample_weight/meta_data/"
export_result_meta_data = False
export_img = True
threshold = 0
num_cores = 8
...
#* DEFINE ITEM LIST
file_list = os.listdir("/app/python-scripts/kevin_workspace/outputs/output0102_v1_submit/train_img/")
item_list = [i[:i.index('.')] for i in file_list]
# item_list = ['100044784']
...
if __name__ == '__main__':
    ...
    unit_price = pd.read_csv('/app/python-scripts/kevin_workspace/assist_data/unit_price0102.csv.gz',parse_dates=['day_dt'],compression='gzip')
